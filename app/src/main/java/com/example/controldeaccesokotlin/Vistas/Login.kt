...
@Composable
fun Login(changePrincipal: (String) -> Unit, controller: ControlAccesoViewModel = viewModel()) {
    var correoIntroducido : String by remember { mutableStateOf("")}
            ...
            Column (
                ...
                TextField(
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(top = 5.dp),
                    onValueChange = {correoIntroducido = it},
                    value = correoIntroducido
                )
                ...
                Button(
                    onClick = {
                        if (controller.comprobarCorreoExiste(correoIntroducido)) {
                            changePrincipal("salas")
                        } else {
